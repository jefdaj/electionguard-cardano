...
* [x] A [publish script](./offchain/publish.py) which publishes the records to Cardano + IPFS
* [x] A [verify script](./offchain/verify.py) which watches the chain and incrementally fetches + verifies the records
