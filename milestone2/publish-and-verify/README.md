...
* An [Aiken validator with some tests](./onchain/)
* [Documentation of the validator](./docs/smart-contract.md)
* A set of [static election records][./offchain/static_records/] generated by an earlier election run
...
+ aiken check --trace-level silent
    ...
    Resolving jefdaj/electionguard-cardano
      Fetched 1 package in 11.81s from cache
   ...
   Collecting all tests scenarios across all modules
    ...
    ┕ with --seed=973066437 → 2 tests | 2 passed | 0 failed
