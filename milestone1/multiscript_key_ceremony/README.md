# multistep key ceremony

Based on the `functional_key_ceremony` integration test. Instead of one script,
...
./multiscript_key_ceremony/main.py
```

And it should generate these files:

```
multiscript_key_ceremony/
├── private_records
│   ├── guardian_1.json
│   ├── guardian_2.json
│   └── guardian_3.json
